...
class MeshDrawer {
	...
	constructor() {
		...
		this.ambientVar = gl.getUniformLocation(this.prog, 'ambient');
		this.enableLightingVar = gl.getUniformLocation(this.prog, 'enableLighting');
		this.lightPosition = gl.getUniformLocation(this.prog, 'lightPos');	
	}
	...
	draw(trans, lightX, lightY, lightZ) {
		...
		gl.uniform3fv(this.lightPosition, normalize([lightX, lightY, lightZ]));
	...
	enableLighting(show) {
		gl.useProgram(this.prog);
		gl.uniform1i(this.enableLightingVar, show);
	}
	
	setAmbientLight(ambient) {
		gl.useProgram(this.prog);
		gl.uniform1f(this.ambientVar, ambient);
	}
}
